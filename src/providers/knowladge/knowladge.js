...
/*
  ...
  and Angular DI.
*/
var KnowladgeProvider = /** @class */ (function () {
    function KnowladgeProvider(url, http) {
        this.url = url;
        this.http = http;
        console.log('Hello KnowladgeProvider Provider');
        this.lang = DomainProvider.lang;
    }
    KnowladgeProvider.prototype.getAllnews = function () {
        return this.http.get(this.url.url + 'api/' + this.lang + '/news');
    };
    KnowladgeProvider.prototype.getnewsDetails = function (news_id) {
        return this.http.get(this.url.url + 'api/' + this.lang + '/news/' + news_id);
    };
    KnowladgeProvider = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [DomainProvider, HttpClient])
    ], KnowladgeProvider);
    return KnowladgeProvider;
}());
export { KnowladgeProvider };
//# sourceMappingURL=knowladge.js.map