...
/*
  ...
  and Angular DI.
*/
var ChampionsNewsProvider = /** @class */ (function () {
    function ChampionsNewsProvider(url, http) {
        this.url = url;
        this.http = http;
        this.lang = DomainProvider.lang;
    }
    ChampionsNewsProvider.prototype.getAllTournaments = function () {
    ...
    ChampionsNewsProvider.prototype.getnewsTournaments = function (news_id) {
    ...
    ChampionsNewsProvider.prototype.live = function () {
        return this.http.get(this.url.url + 'api/live');
    };
    ChampionsNewsProvider = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [DomainProvider, HttpClient])
    ], ChampionsNewsProvider);
    return ChampionsNewsProvider;
}());
export { ChampionsNewsProvider };
//# sourceMappingURL=champions-news.js.map