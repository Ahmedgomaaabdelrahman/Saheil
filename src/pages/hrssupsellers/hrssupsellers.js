...
var HrssupsellersPage = /** @class */ (function () {
    function HrssupsellersPage(veterinations, navCtrl, navParams) {
        this.veterinations = veterinations;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    HrssupsellersPage.prototype.ionViewWillLoad = function () {
        var _this = this;
        this.veterinariansArray = [];
        this.veterinations.getAllServices(5).subscribe(function (veterinarians) {
            _this.veterinariansArray = veterinarians;
            console.log(_this.veterinariansArray);
        });
    };
    HrssupsellersPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AlldoctorsPage');
    };
    HrssupsellersPage.prototype.gotodetails = function (id) {
        this.navCtrl.push(HorsesuppPage, id);
        // this.navCtrl.push(DoctordetailsPage,id);
    };
    HrssupsellersPage = __decorate([
        Component({
    ...
    return HrssupsellersPage;
}());
export { HrssupsellersPage };
//# sourceMappingURL=hrssupsellers.js.map