...
export class ClinkdetailsPage {
    ...
    constructor(private nav:NavController,public view:ViewController,public platform:Platform,public veterinarian:VeterinariansProvider,public navParams: NavParams) {
        platform.ready().then(() => {
            // this.loadMap();
        });
    }
