...
var ClinkdetailsPage = /** @class */ (function () {
    function ClinkdetailsPage(nav, view, platform, veterinarian, navParams) {
        this.nav = nav;
        this.view = view;
    ...
    ClinkdetailsPage.prototype.ionViewWillLoad = function () {
        var _this = this;
    ...
    ClinkdetailsPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad DoctordetailsPage');
    };
    //map
    ClinkdetailsPage.prototype.loadMap = function (ll, uu) {
    ...
    ClinkdetailsPage.prototype.addMarker = function (LatLng) {
    ...
    ClinkdetailsPage.prototype.contact = function () {
        this.nav.push(SendrequestPage, this.id);
    };
    __decorate([
        ViewChild('map'),
        __metadata("design:type", ElementRef)
    ], ClinkdetailsPage.prototype, "mapElement", void 0);
    ClinkdetailsPage = __decorate([
        Component({
    ...
    return ClinkdetailsPage;
}());
export { ClinkdetailsPage };
//# sourceMappingURL=clinkdetails.js.map